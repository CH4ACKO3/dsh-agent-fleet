...
Feature plugins can register a capability namespace through `ctx.fleetAccess.registerNamespace(...)`; their permission ids then participate in the same groups and OP expansion.
