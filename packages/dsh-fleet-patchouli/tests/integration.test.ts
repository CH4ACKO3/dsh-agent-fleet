...
describe('dsh-fleet-patchouli', () => {
  it('activates only after Fleet and Patchouli services are available and routes durable events by visibility scope', async () => {
    ...
    fixture.event({
      ...
      data: {
        ...
        message: {
          ...
          conversationId: 'dm:member:lead:member:reviewer',
          text: 'Old decision',
        },
      },
    })
    ...
    expect(fixture.update.mock.calls[1]?.[0].meta.scope)
      .toBe('fleet:team-1:conversation:dm:member:lead:member:reviewer')
