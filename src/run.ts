      ...
      stages: {
        ...
        items: {
          type: 'object', additionalProperties: false, properties: {
            ...
            owners: { type: 'array', required: true, items: { type: 'string' }, description: 'For a Goal, prefer one accountable owner: every listed owner must submit and any block terminates the dependent branch. Use separate dependent stages for collaborators or reviewers. For a Vote, list all required voters.' },
