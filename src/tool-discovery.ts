...
export const FLEET_TOOL_CATALOG: readonly FleetToolCatalogEntry[] = [
  ...
  { name: 'fleet_task', group: 'tasks', family: 'planning', source: 'namespace', namespace: 'task', description: 'Read and manage recursive durable Tasks, owner completion intents, stable states, trigger-driven ReconcileAttempts, Vote children, and required message obligations.', keywords: 'task owner intent list tree child reconcile trigger stable state event timeout vote requirement must reply complete block cancel project 任务 owner 负责人 意图 列表 子任务 状态 调和 触发器 事件 超时 投票 必回 完成 阻塞 取消 项目', aliases: ['我的任务', 'owner意图', '必须回复', '必回任务', '完成任务'], actions: ['list', 'owner_list', 'get', 'create', 'update', 'cancel', 'comment', 'progress', 'claim', 'settle', 'complete', 'block', 'signal'], privilegedActions: { list: 'task.read', owner_list: 'task.read', get: 'task.read', create: 'task.create', update: 'task.update', cancel: 'task.manage', comment: 'task.comment', progress: 'task.progress', claim: 'task.progress', settle: 'task.update', complete: 'task.progress', block: 'task.progress', signal: 'task.update' } },
