...
const FLEET_TOOL_CATALOG: readonly FleetToolCatalogEntry[] = [
  ...
  { name: 'fleet_shared', group: 'resources', description: 'Read and update small shared Team files.', keywords: 'shared file plan rule checklist 共享 文件 计划 规则 清单', actions: ['read', 'write'], privilegedActions: { write: 'resource.write' } },
  ...
  { name: 'fleet_task', group: 'tasks', description: 'Create and maintain persistent Team work items.', keywords: 'task issue assignee dependency todo 任务 工单 指派 依赖 待办', actions: ['list', 'get', 'create', 'update', 'comment', 'progress', 'complete', 'reopen'], constraints: ['changing a task owned by others requires responsibility for it or task.manage'] },
  { name: 'fleet_schedule', group: 'schedule', description: 'Create persistent reminders that wake members.', keywords: 'schedule reminder recurring wake timer 提醒 定时 周期 唤醒', actions: ['list', 'create', 'complete', 'cancel'], privilegedActions: { create: 'schedule.create' }, constraints: ['complete and cancel are limited by reminder ownership or assignment'] },
  { name: 'fleet_calendar', group: 'calendar', description: 'Create and manage Team calendar events.', keywords: 'calendar event time attendee 日历 日程 事件 时间 参会人', actions: ['list', 'get', 'create', 'update', 'rsvp', 'cancel', 'close', 'freebusy'], constraints: ['changing an event organized by another member requires calendar.manage'] },
  { name: 'fleet_document', group: 'documents', description: 'Read and edit durable shared documents.', keywords: 'document markdown plan edit comment 文档 markdown 计划 编辑 评论', actions: ['list', 'search', 'get', 'create', 'update', 'comment', 'reply', 'resolve', 'revert'], privilegedActions: { create: 'document.write', update: 'document.write', comment: 'document.write', reply: 'document.write', resolve: 'document.write', revert: 'document.write' } },
