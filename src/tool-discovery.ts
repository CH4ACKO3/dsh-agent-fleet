...
export const FLEET_TOOL_CATALOG: readonly FleetToolCatalogEntry[] = [
  ...
  { name: 'fleet_task', group: 'tasks', family: 'planning', source: 'namespace', namespace: 'task', description: 'Read and manage persistent Team tasks, including durable attempts, continuations, timeouts, Votes, and required message obligations.', keywords: 'task assignment attempt continuation wait event vote requirement must reply complete project 任务 指派 推进 等待 事件 投票 必回 完成 项目', aliases: ['必须回复', '必回任务', '完成任务'], actions: ['list', 'get', 'create', 'update', 'comment', 'progress', 'claim', 'settle', 'complete', 'reopen'], privilegedActions: { list: 'task.read', get: 'task.read', create: 'task.create', update: 'task.update', comment: 'task.comment', progress: 'task.progress', claim: 'task.progress', settle: 'task.update', complete: 'task.update', reopen: 'task.update' } },
