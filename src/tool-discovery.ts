...
export const FLEET_TOOL_CATALOG: readonly FleetToolCatalogEntry[] = [
  ...
  { name: 'fleet_task', group: 'tasks', family: 'planning', source: 'namespace', namespace: 'task', description: 'Read and manage recursive durable Tasks, stable states, trigger-driven ReconcileAttempts, Vote children, and required message obligations.', keywords: 'task tree child reconcile trigger stable state event timeout vote requirement must reply complete project 任务 子任务 状态 调和 触发器 事件 超时 投票 必回 完成 项目', aliases: ['必须回复', '必回任务', '完成任务'], actions: ['list', 'get', 'create', 'update', 'comment', 'progress', 'claim', 'settle', 'complete', 'reopen', 'signal'], privilegedActions: { list: 'task.read', get: 'task.read', create: 'task.create', update: 'task.update', comment: 'task.comment', progress: 'task.progress', claim: 'task.progress', settle: 'task.update', complete: 'task.update', reopen: 'task.update', signal: 'task.update' } },
