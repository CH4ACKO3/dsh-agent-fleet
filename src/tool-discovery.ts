...
export const FLEET_TOOL_CATALOG: readonly FleetToolCatalogEntry[] = [
  ...
  { name: 'fleet_task', group: 'tasks', family: 'planning', source: 'namespace', namespace: 'task', description: 'Read and manage persistent Team tasks, including required message obligations.', keywords: 'task assignment requirement must reply complete project 任务 指派 必回 完成 项目', aliases: ['必须回复', '必回任务', '完成任务'], actions: ['list', 'get', 'create', 'update', 'comment', 'progress', 'complete', 'reopen'], privilegedActions: { list: 'task.read', get: 'task.read', create: 'task.create', update: 'task.update', comment: 'task.comment', progress: 'task.progress', complete: 'task.update', reopen: 'task.update' } },
