...
export const FLEET_TOOL_CATALOG: readonly FleetToolCatalogEntry[] = [
  ...
  { name: 'fleet_resurrect', group: 'core', family: 'recovery', source: 'host', description: 'Give one exhausted peer a bounded protocol-recovery grant after assigning replacement work.', keywords: 'resurrect recover retry exhausted peer member 复活 恢复 重试 耗尽 成员 同伴', aliases: ['复活成员', '恢复异常成员', '补充重试'], actions: ['resurrect'] },
